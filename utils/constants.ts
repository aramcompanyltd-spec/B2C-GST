...
export const DEFAULT_ACCOUNT_TABLE: AccountCategory[] = [
    ...
    { id: '5', name: 'Entertainment', ratio: 0.5, code: '327', isDeletable: true },
    { id: '6', name: 'General Expenses', ratio: 1.0, code: '335', isDeletable: true },
    { id: '7', name: 'Insurance', ratio: 1.0, code: '340', isDeletable: true },
    { id: '8', name: 'Power', ratio: 1.0, code: '384', isDeletable: true },
    { id: '9', name: 'Motor Vehicle Expenses', ratio: 0.25, code: '410', isDeletable: true },
    { id: '10', name: 'Home Office Expenses', ratio: 0.25, code: '425', isDeletable: true },
    { id: '11', name: 'Rates', ratio: 1.0, code: '440', isDeletable: true },
    { id: '12', name: 'Staff Expenses', ratio: 1.0, code: '457', isDeletable: true },
    { id: '13', name: 'Mobile Phone', ratio: 1.0, code: '464', isDeletable: true },
    { id: '14', name: 'Travel - National', ratio: 1.0, code: '469', isDeletable: true },
    { id: '15', name: 'Travel - International', ratio: 0.0, code: '470', isDeletable: true },
    { id: '16', name: 'Salary and Wages', ratio: 0.0, code: '475', isDeletable: true },
    { id: '17', name: 'GST Payment or Refund', ratio: 0.0, code: '630', isDeletable: true },
    { id: '18', name: 'Transfers', ratio: 0.0, code: '997', isDeletable: true },
    { id: '19', name: 'Uncategorized', ratio: 0.0, code: '998', isDeletable: true },
];
